<div id="free-app" class="page-box page-box--free-app<?php if(get_sub_field('use_border')): ?> page-box--bordered<?php endif; ?><?php if(get_sub_field('hide_on_mobile')): ?> is-hidden<?php endif; ?>">
    <div class="wrap">
