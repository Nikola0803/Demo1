    ...
    <div class="wrap">
        <div class="support">
            ...
            <div class="support__content support__content--item">
                ...
                <?php if( have_rows('service_charges') ):
                // loop through the rows of data
                while ( have_rows('service_charges') ) : the_row(); ?>
                <?php 
                    if( get_row_layout() == 'service_charges_item' ):
                        include('template-parts/service.php');
                    elseif( get_row_layout() == 'invoices' ):
                        include('template-parts/invoices.php');
                    elseif( get_row_layout() == 'talk_talk' ):
                        include('template-parts/site.php');
                    elseif( get_row_layout() == 'text_with_icons' ):
                        include('template-parts/text_icons_large.php');
                    elseif( get_row_layout() == 'voip_installation' ):
                        include('template-parts/voip_installation.php');
                    endif; 
                ?>
                <?php endwhile; ?>
                <?php else: ?>
                    ...
                    <div class="support__popular-post">
                        ...
                        <div class="support__popular-item<?php if( get_field('do_not_hide') == false ) : ?> collapsed<?php endif; ?>">
                            <h2><?php the_title(); ?></h2>
                    ...
                    the_posts_pagination( array(
                        'prev_text' => twentyseventeen_get_svg( array( 'icon' => 'arrow-left' ) ) . '<span class="screen-reader-text">' . __( 'Previous page', 'site' ) . '</span>',
