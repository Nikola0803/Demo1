<div id="box-price" class="page-price-v2 page-box--bordered<?php if(get_sub_field('hide_on_mobile')): ?> is-hidden<?php endif; ?>">
    ...
    <div class="wrap wrap--price-boxes">
        ...
        <?php if (have_rows('box_with_price')): $i = 0 ?>
            <div class="page-price-v2__list <?php if($count == 2): ?>page-price-v2__js-slider-mobile-two<?php endif; ?> <?php if($count == 3): ?>page-price-v2__js-slider-mobile-three<?php endif; ?> <?php if($count > 3): ?>page-price-v2__js-slider-all<?php endif; ?>">
                ...
                <?php get_sub_field('table_theme'); ?>
                    ...
                    ?>
                        ...
                        <div class="page-price-v2__slide page-price-v2_slide-id<?php echo $i; ?>">
                            <div class="page-price-v2__item  <?php if($theme): ?>page-price-v2__item--<?php echo $theme; ?><?php endif; ?>">

                                <div class="page-price-v2__item-pre" <?php if($customTheme) { echo 'style="color:'. $customTheme .'"'; } ?>>
                                    <?php if($pre_title): ?><h3><?php echo $pre_title; ?></h3><?php endif; ?>
                                </div><!-- /.page-price-v2__item-pre -->

                                <div class="page-price-v2__item-content">

                                    <div class="page-price-v2__top" <?php if($customTheme) { echo 'style="color:'. $customTheme .'"'; } ?>>

                                        <?php if($title): ?><h2><?php echo $title; ?></h2><?php endif; ?>

                                        <div class="page-price-v2__value" <?php if($customTheme) { echo 'style="color:'. $customTheme .'"'; } ?>>
                                            ...
                                            */ ?>
                                            ...
                                            <?php if($price): ?>
                                                <div class="page-price-v2__value-item">
                                                    <p><?php echo $price; ?></p>
                                                    <?php if($tipPrice): ?>
                                                    <div class="tooltip">
                                        ...
                                        </div><!-- /.page-price-v2__value -->

                                    </div><!-- /.page-price-v2__top -->

                                    <?php if(have_rows('info')): ?>
                                    <ul class="page-price-v2__item-info-list">
                                        <?php
                                        ...
                                        ?>
                                        <li class="page-price-v2__item-info">
                                            <div class="page-price-v2__info-content <?php if($text) { echo 'page-price-v2__info-content--wtxt'; } ?>">

                                                <div>

                                                    <h3 class="page-price-v2__info-title">
                                                        <?php if($name): ?>
                                                            <?php echo $name; ?>
                                                        <?php endif; ?>
                                                        <?php if($tip): ?>
                                                    ...
                                                    <?php if($name_sub): ?>
                                                    <h5 class="page-price-v2__info-sub-title">
                                                        <?php echo $name_sub; ?>
                                                    </h5>
                                                    <?php endif; ?>
                                                ...
                                                <?php if($text): ?>
                                                <strong class="page-price-v2__info-benefit" <?php if($customTheme) { echo 'style="color:'. $customTheme .'"'; } ?>>
                                                    <?php echo $text; ?>
                                                </strong>
                                                <?php endif; ?>
                                        ...
                                        <?php endwhile; ?>
                                    </ul><!-- /.page-price-v2__info -->
                                    <?php endif; ?>

                                    <div class="page-price-v2__controls">
                                ...
                                </div><!-- /.page-price-v2__item-content -->
